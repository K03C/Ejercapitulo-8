...
como la forma de acceso a los campos de las variables o apuntadores de tipo estructura, tanto para lectura como para escritura.
Se utiliza ademas una función que recibe como parametro un apuntador de tipo estructura.*/
...
/*Funciión que permite leer los campos de un apuntador de tipo estructura
empleado. */
{
...
para que el lector pueda apreciar tambien las diferentes formas en que los campos reciben valores. */

/*En el programa principal se leen los campos de una variable, e3, y un apuntador de tipo estructura,
*e1. */
