...
acceso a los campos de las variables de tipo estructura tanto para asignacion de valores como
...
void main(void)
{
    ...
    variable. a1, a2 y a3 son variables de tipo estructua alumno. */
    ...
    /*   Observa otra forma de escribir los campos
    de la variable de tipo estructura a3.  */
    printf("\nDatos del alumno 3\n");
